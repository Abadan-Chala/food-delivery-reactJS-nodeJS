...
const placeOrder = async (req, res) => {
    try {
        const newOrder = new orderModel({
            ...
            amount: req.body.amount,
            address: req.body.address,
            selectedBank: req.body.selectedBank, // Add selected bank
            accountNumber: req.body.accountNumber, // Add account number
        });

        await newOrder.save(); // Save the order to the database
        await userModel.findByIdAndUpdate(req.body.userId, { cartData: {} }); // Clear the user's cart

        // Simulate payment success (replace this with actual e-banking integration)
